...
public class ComprarBonoPlan extends Plan {
    ...
    public void body()
    {
            ...
            if (result.length>0)
            {
                ...
                int valorBono = 1000;
                int rondasRestantes = 7- informacion.getRonda();
                int beneficiosPorBono = rondasRestantes * valorBono;
                //Parametros de decision
                int limiteBeneficiosBono = 3000;
                int limiteDinero = 20000;
                //Decidir la cantidad de bonos
                ...
                int cantidadBonos = 0;
                for (int i = 0; i<3; i++){
                    if ((dinero.getCantidad()- (valorBono*(cantidadBonos +1))) >= limiteDinero && beneficiosPorBono >= limiteBeneficiosBono)
                        cantidadBonos ++;
                }                
